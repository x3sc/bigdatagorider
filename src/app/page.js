  ...
  const faqItems = [
    {
      ...
      resposta:
        "Basta clicar no botão 'Cadastre-se' no menu superior e preencher o formulário com seus dados. O processo leva menos de 1 minuto!",
    },
    {
      pergunta: "Quais são as formas de pagamento aceitas?",
      resposta:
        "Aceitamos cartões de crédito (Visa, Mastercard, Elo), débito, PIX e transferência bancária.",
    },
    {
      pergunta: "A GoRide possui seguro para os veículos?",
      resposta:
        "Sim, todos nossos veículos possuem seguro completo incluído no valor do aluguel ou serviço.",
    },
    {
      pergunta: "Como funciona o cancelamento de reservas?",
      resposta:
        "Você pode cancelar gratuitamente até 24 horas antes da reserva. Após esse período, pode haver cobrança de taxa conforme nossa política.",
    },
  ];
    ...
    <main>
      ...
      <section className={styles.section}>
        <div className={styles.jornada}>
          ...
          <h1 className={styles.prioridade}>
            Sua Jornada,
            <br />
            nossa prioridade
          </h1>
          <p>
            Mobilidade sob medida, onde e quando <br />
            você precisar
          </p>
        </div>
        <div>
      ...
      <div className={styles.mobilidade}>
        ...
        <div className={styles.aviaozao}>
          <h1>
            <b>
              Encontre a Mobilidade
              <br />
              Perfeita para você
            </b>
          </h1>
          <p>
            Na <strong>Go Ride</strong>, conectamos você às{" "}
            <strong>melhores soluções</strong>
            de
            <br />
            <strong>transporte</strong>, seja para alugar,comprar, ou contratar
            serviços
            <br />
      ...
      <div className={styles.escolher}>
        <h1>
          <b>Por que escolher a Go Ride ?</b>
        </h1>
        <Image
      ...
      <div className={styles.container}>
        ...
        <div className={styles.bola}>
          ...
          <p>
            aluguel de curto ou longo
            <br />
            prazo, financiamento facilitado
          </p>
        </div>
        <div className={styles.bola}>
          <Image
          ...
          <p>
            Seguro completo e assistência 24/7
            <br />
      ...
      <div className={styles.pronto}>
        <div className={styles.comeco}>
          ...
          <p>
            Seja para alugar, comprar ou trabalhar conosco,
